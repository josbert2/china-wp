...
if ( ! class_exists( 'Porto_Elementor_Init' ) ) :
	...
	class Porto_Elementor_Init {
		...
		public function after_page_first_print( $document, $is_excerpt, $with_css ) {
			...
			if ( $is_saved && ( ! Elementor\Plugin::$instance->experiments->is_feature_active( 'e_element_cache' ) || get_post_meta( $post_id, Elementor\Core\Base\Document::CACHE_META_KEY, true ) ) ) {
				return;
			}
		...
		public function create_elementor_page_assets( $post_id, $editor_data, $with_css = false ) {
			...
			if ( 'porto_builder' == get_post_type( $post_id ) && Elementor\Plugin::$instance->experiments->is_feature_active( 'e_element_cache' ) ) {
