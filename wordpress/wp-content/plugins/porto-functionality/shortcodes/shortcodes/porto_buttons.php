		...
		array(
			...
			'params'          => array_merge(
				...
				array(
					...
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Use as "Content Collapsible action"', 'porto-functionality' ),
						'hint'        => '<img src="' . PORTO_HINT_URL . 'wd_content_collapse.gif"/>',
						'param_name'  => 'use_collapse',
						'value'       => array( __( 'Yes, please', 'js_composer' ) => 'yes' ),
						'description' => __( 'To use this option, you should turn on the "Collapsible Content" of the column', 'porto-functionality' ),
