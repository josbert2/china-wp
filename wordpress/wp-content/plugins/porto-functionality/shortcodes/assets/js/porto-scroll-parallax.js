                ...
                if ( 'width' == self.options.cssProperty ) {
                    if ( self.progress >= self.options.cssValueEnd ) {
                        ...
                        if ( 'vw' == self.options.cssValueUnit ) {
                            ...
                            self.$el[0].style.setProperty('margin-left', 'auto', 'important');
                            self.$el[0].style.setProperty('margin-right', 'auto', 'important');
                        }
                    }
                }
                ...
                if( $scrollableWrapper.length ) {
                    ...
                    if ( 'width' == self.options.cssProperty ) {
                        if ( 'vw' == self.options.cssValueUnit ) {
                            ...
                            $scrollableWrapper[0].style.setProperty('margin-left', 'auto', 'important');
                            $scrollableWrapper[0].style.setProperty('margin-right', 'auto', 'important');
                        }
                    }
