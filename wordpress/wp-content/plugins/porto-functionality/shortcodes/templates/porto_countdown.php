...
if ( $enable_field_dynamic ) {
	...
	if ( ! empty( $dynamic_datetime ) && is_array( $dynamic_datetime ) ) {
		$dynamic_datetime = $field_dynamic_before . apply_filters( 'porto_dynamic_el_render_array_value', implode( '<span class="sep">, </span>', $dynamic_datetime ), $dynamic_datetime ) . $field_dynamic_after;
	} else {
