<?php
/**
 * Porto Dynamic WooCommerce Image Tags class
 *
 * @author     P-THEMES
 * @version    3.5.0
 */
...
class Porto_El_Custom_Image_Woo_Tag extends Elementor\Core\DynamicTags\Data_Tag {

	public function get_name() {
		return 'porto-custom-image-woo';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => Porto_Func_Dynamic_Tags_Content::get_instance()->get_dynamic_woo_object_image(),
			)
		);
	...
	public function get_value( array $options = array() ) {
		...
		$img = Porto_Func_Dynamic_Tags_Content::get_instance()->get_dynamic_woo_image( $atts['dynamic_image_source'] );
