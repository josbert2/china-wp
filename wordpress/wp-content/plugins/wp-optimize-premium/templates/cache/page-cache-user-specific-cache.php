	...
	<div class="notice notice-warning">
		...
		<?php if ($is_nginx) { ?>
			...
			<p>
				...
				<?php
					// translators: %s is the path to the user specific cache
					echo sprintf(esc_html__('As the user specific cache might contain personal information, it is highly advised to configure your server to disallow direct access to %s.', 'wp-optimize'), esc_html($path_to_cache));
				?>
			</p>
			<p>
