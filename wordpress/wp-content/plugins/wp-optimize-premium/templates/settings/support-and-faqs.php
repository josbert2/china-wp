...
<div class="wpo-fieldgroup">
	...
	<ul>
		...
		<li><?php $wp_optimize->wp_optimize_url('https://getwpo.com/premium-support/', __('Support is available here.', 'wp-optimize')); ?></li>
		<li>
			<?php
				...
				$message .= ' ';
				$message .= $wp_optimize->wp_optimize_url('https://getwpo.com/premium-support/', esc_html__('please tell us why at this link.', 'wp-optimize'), '', '', true);
