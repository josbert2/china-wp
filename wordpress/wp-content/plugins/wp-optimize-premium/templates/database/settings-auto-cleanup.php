	...
	<div class="wpo-fieldgroup">
		<div id="wp-optimize-auto-options">
			...
			<p class="innodb_force_optimize--container<?php echo $show_innodb_option ? '' : ' hidden'; ?>">
				...
				<?php $wp_optimize->wp_optimize_url('https://teamupdraft.com/documentation/wp-optimize/topics/database-optimization/faqs/', __('Warning: you should read the FAQ about the risks of this operation first.', 'wp-optimize')); ?>
			</p>
