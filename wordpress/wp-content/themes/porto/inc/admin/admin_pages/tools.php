	...
	<main style="display: block">
		...
		<table class="porto-table">
			...
			<tbody>
				...
				<tr>
					<td>
						<h4><?php esc_html_e( 'Porto cached data', 'porto' ); ?></h4>
						<p><?php esc_html_e( 'This tool will clear post/query transients and object caches.', 'porto' ); ?></p>
					</td>
					<td>
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=porto-tools&action=clear_caches&_wpnonce=' . $nonce ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Clear caches', 'porto' ); ?></a>
					</td>
				</tr>
				<tr>
					<td>
